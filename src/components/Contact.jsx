        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600">
              220 Coit Rd #570, Plano, TX 75075,<br />United States
            </p>
          </motion.div>
        </div>
      </div>
            ...
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 -bottom-8">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className={`font-bold py-4 px-12 rounded-full text-lg shadow-xl transition-all whitespace-nowrap text-white ${cloudflareState === 'success' ? 'bg-[#dca843] hover:bg-[#c99e4c] hover:shadow-2xl' : 'bg-gray-400 cursor-not-allowed'
                    }`}
